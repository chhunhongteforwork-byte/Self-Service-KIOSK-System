...
CSRF_TRUSTED_ORIGINS = [
    'https://*.railway.app',
    'https://self-service-kiosk-system-backend-production.up.railway.app',
]
...
# Database
# Use SQLite locally, but Postgres on Railway (via DATABASE_URL)
DATABASES = {
...
CORS_ALLOW_ALL_ORIGINS = True # For MVP. In prod, lock this down to your Frontend URL.
